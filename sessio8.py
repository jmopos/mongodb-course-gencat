...
#Drop (eliminem abans per poder executar moltes vegades) and Create my_collection collection
...
print(db.my_collection.insert_one({"x":10, "name":"Alberto", "surname":"Soto"}).inserted_id)
#Find_one element
